...
from envs.cleanup_env import CleanupEnv, env as aec_env # Import both parallel and aec env factory
from envs.constants import (ACTION_MEANING, APPLE, CLEANUP_MAP,
...
from envs.constants import (CLEAN_REWARD, APPLE_REWARD)
from envs.constants import (WALL, APPLE_SPAWN, WASTE_INIT, RIVER, STREAM)
from envs.constants import (APPLE_RESPAWN_PROBABILITY, WASTE_SPAWN_PROBABILITY, THRESHOLD_DEPLETION, THRESHOLD_RESTORATION)
